 ...
 * <li><b>kL</b> - minimum power (a constant power added in the error's direction to overcome
 * static forces)</li>
 * </ul>
 *
 * @author DrPixelCat
...
public class PDFLController extends Controller {
    ...
    /**
     * A simple class to hold the PDFLCoefficients for the PDFLController. This makes it easier
     * to set
    ...
    public static class PDFLCoefficients {
        ...
        /**
         * Creates a PDFLCoefficients object with the given P, D, and L values, with the F term
         * set to
