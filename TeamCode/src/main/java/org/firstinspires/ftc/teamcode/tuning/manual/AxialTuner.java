 ...
 * the heading controller to maintain its heading while driving.
 *
...
public class AxialTuner extends OpMode {
    ...
    public void init() {
        ...
        fullTelem.addLine(
                "Hold X to move forward 64 inches, B to move backward 6 inches, and A to drive back to the start position."
        );
        fullTelem.update();
    }
