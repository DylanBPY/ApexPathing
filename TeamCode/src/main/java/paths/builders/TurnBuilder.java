...
public class TurnBuilder {
    ...
    public TurnBuilder(Pose startPose) {
        ...
        this.angularVelLimitRad = config.angularVelLimitRad;
        this.angularAccelLimitRad = config.angularAccelLimitRad;
    }
    ...
    public TurnBuilder setAngularVelocityLimit(Angle limit) {
        if (limit.getRad() > config.angularVelLimitRad) {
    ...
    public TurnBuilder setAngularAccelerationLimit(Angle limit) {
        if (limit.getRad() > config.angularAccelLimitRad) {
    ...
    public Turn profiledBuild() {
        ...
        finalTurn.setFeedforwardLut(motionGen.generate(
                finalTurn, config.headingCoeffs.kS, config.angularKV, config.angularKA
        ));
